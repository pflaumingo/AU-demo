class HeatingCoilComponentSummary < JSONable
  attr_accessor :cad_object_id, :sizing_method, :time_of_peak, :total_capacity, :ventilation_load, :ov_undr_sizing,
                :air_flow, :enter_db, :leave_db, :water_flow, :water_enter_temp, :water_leave_temp
